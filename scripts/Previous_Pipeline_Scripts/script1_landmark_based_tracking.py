"""
================================================================================
SCRIPT 1 v21: PROJECTION-BASED TRACKING
================================================================================
...
print("=" * 70)
print("SCRIPT 1 v21: PROJECTION-BASED TRACKING")
print("Head stationary -> Project 3D to 2D instead of tracking")
print("=" * 70)
...
VGGT_SIZE = 518
MAX_VGGT_FRAMES = 80  # Use more frames for better reconstruction
...
class MultiViewAnnotator:
    ...
    def triangulate_point(self, obj_id):
        ...
        # Collect 3D points from each observation
        points_3d = []
        ...
        # Average (could use more sophisticated triangulation)
        ...
        if len(points_3d) >= 3:
            ...
            if np.sum(mask) >= 1:
                return np.mean(points_3d[mask], axis=0)
...
def generate_tracking_from_3d(frames, vggt_data, crop_info, positions_3d, sam2_image):
    ...
    print(f"[OK] Generated tracking for {len(tracking)} frames")
...
def main():
    ...
    print("\n" + "=" * 70)
    print("EEG ELECTRODE REGISTRATION v21")
    ...
    print("Next: python script3_v5.py")
    print("=" * 70)
